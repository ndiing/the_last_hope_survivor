...
class DemoNavigationBarLayoutListFormatNested extends MDComponent {
    constructor() {
        super();
...
customElements.define("demo-navigation-drawer-layout-list-format-nested", DemoNavigationBarLayoutListFormatNested);

export default document.createElement("demo-navigation-drawer-layout-list-format-nested");
