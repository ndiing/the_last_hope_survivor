...
customElements.define("demo-navigation-drawer-flat-push-menu", DemoNavigationBar);

export default document.createElement("demo-navigation-drawer-flat-push-menu");
