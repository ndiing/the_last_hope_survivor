...
customElements.define("demo-navigation-drawer-nested-list-modal", DemoNavigationBar);

export default document.createElement("demo-navigation-drawer-nested-list-modal");
