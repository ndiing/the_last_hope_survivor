...
class DemoNavigationBarLayoutListFormatNestedModal extends MDComponent {
    constructor() {
        super();
...
customElements.define("demo-navigation-drawer-layout-list-format-nested-modal", DemoNavigationBarLayoutListFormatNestedModal);

export default document.createElement("demo-navigation-drawer-layout-list-format-nested-modal");
