...
class DemoToolGroup extends MDComponent {
    constructor() {
        ...
        this.tools = [
            //
            { component: "avatar", src: "https://api.dicebear.com/9.x/icons/svg?seed=10&scale=50" },
            { component: "image", src: "https://api.dicebear.com/9.x/icons/svg?seed=10&scale=50" },
            { component: "video", src: "https://api.dicebear.com/9.x/icons/svg?seed=10&scale=50" },
