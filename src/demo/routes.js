...
const routes = [
    {id:'0',path:'/',label:'Main',component:testMain,children:[
        ...
        // {id:'40',path:'/tree-item',label:'Tree Item',load:() => import('./tree-item/tree-item.js').then(module=>module.default),},
        {id:'41',path:'/tree',label:'Tree',load:() => import('./tree/tree.js').then(module=>module.default),},
        // {id:'42',path:'/push-menu-item',label:'Push Menu Item',load:() => import('./push-menu-item/push-menu-item.js').then(module=>module.default),},
        {id:'43',path:'/push-menu',label:'Push Menu',load:() => import('./push-menu/push-menu.js').then(module=>module.default),},

        // {id:'44',path:'/loading-indicator',label:'Loading Indicator',load:() => import('./loading-indicator/loading-indicator.js').then(module=>module.default)},
        // {id:'45',path:'/progress-indicator',label:'Progress Indicator',load:() => import('./progress-indicator/progress-indicator.js').then(module=>module.default)},
        // {id:'46',path:'/menu',label:'Menu',load:() => import('./menu/menu.js').then(module=>module.default)},
        // {id:'47',path:'/navigation-bar',label:'Navigation Bar',load:() => import('./navigation-bar/navigation-bar.js').then(module=>module.default)},
        // {id:'48',path:'/navigation-drawer',label:'Navigation Drawer',load:() => import('./navigation-drawer/navigation-drawer.js').then(module=>module.default)},
        // {id:'49',path:'/navigation-rail',label:'Navigation Rail',load:() => import('./navigation-rail/navigation-rail.js').then(module=>module.default)},  
        {id:'50',path:'/radio-button',label:'Radio Button',load:() => import('./radio-button/radio-button.js').then(module=>module.default)},
        // {id:'51',path:'/search',label:'Search',load:() => import('./search/search.js').then(module=>module.default)},
        // {id:'52',path:'/bottom-sheet',label:'Bottom Sheet',load:() => import('./bottom-sheet/bottom-sheet.js').then(module=>module.default)},
        // {id:'53',path:'/side-sheet',label:'Side Sheet',load:() => import('./side-sheet/side-sheet.js').then(module=>module.default)},
        // {id:'54',path:'/slider',label:'Slider',load:() => import('./slider/slider.js').then(module=>module.default)},
        // {id:'55',path:'/snackbar',label:'Snackbar',load:() => import('./snackbar/snackbar.js').then(module=>module.default)},
        {id:'56',path:'/switch',label:'Switch',load:() => import('./switch/switch.js').then(module=>module.default)},
        // {id:'57',path:'/tab',label:'Tab',load:() => import('./tab/tab.js').then(module=>module.default)},
        // {id:'58',path:'/text-field',label:'Text Field',load:() => import('./text-field/text-field.js').then(module=>module.default)},
        // {id:'59',path:'/toolbar',label:'Toolbar',load:() => import('./toolbar/toolbar.js').then(module=>module.default)},
        // {id:'60',path:'/tooltip',label:'Tooltip',load:() => import('./tooltip/tooltip.js').then(module=>module.default)},
    ]},
    {id:'61',path:'*',label:'Not Found',component:testNotFound,redirectTo:'/'},
]
