...
class DemoNavigationRailWithIcon extends MDComponent {
    render() {
        /* prettier-ignore */
        return html`
            <md-layout>
...
customElements.define("demo-navigation-rail-with-icon", DemoNavigationRailWithIcon);

export default document.createElement("demo-navigation-rail-with-icon");
